  ...
  return (
    ...
    >
      <div className='flex flex-col justify-center items-center text-center my-4' > 
        <motion.h1 className='text-3xl sm:text-7xl sm:max-w-[790px] mx-auto mt-10 text-white'
        initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        <motion.button onClick={onclickhandler} className='sm:text-lg text-white bg-purple-600 w-auto mt-8 px-12 my-2.5 flex items-center gap-2 rounded-full h-10 cursor-pointer'
