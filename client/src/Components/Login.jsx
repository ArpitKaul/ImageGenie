...
const Login = () => {
  ...
  return (
    <div className='fixed  top-0 left-0 right-0 bottom-0 z-10 background-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      >
        ...
        {state !== 'Login' && <div className='border px-6 [y-2 flex items-centergap-2 rounded-full mt-5'>
            <img src={assets.user_icon} alt="" />
            <input className='outline-none text-sm' type="text"  placeholder='Full Name' required   />
        </div>}
        <div className='border px-6 [y-2 flex items-centergap-2 rounded-full mt-5'>
